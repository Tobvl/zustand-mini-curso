...
export const BlackBears = () => {
  ...
  // Aqui se obtiene el estado de los osos y se puede
  // obtener los métodos igualmente.
  // TODO OJO... Cuidado con destructurar
...
export const BearDisplay = () => {
  ...
  // useShallow analiza las propiedades del objeto (state y luego state.bears)
